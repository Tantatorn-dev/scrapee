...
/**
 * Returns the GeolocationMarker class.
 *
 * Unfortunately, the GeolocationMarker class can only be defined after
 * google.maps.MVCObject is defined, when the Maps API is loaded.
 * This function should be called by initMap.
 */
function createGeolocationMarker(google) {
  /**
   * @constructor
...
export default createGeolocationMarker;
